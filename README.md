...
Semantic HTML clearly defines content as opposed to non-semantic which tells nothing about its content.
2. What are the 4 areas of the box model?
content edge, padding edge, border edge and margin edge.
3. While using flexbox, what axis does the following property work on: ```align-items: center```?
At the center of the cross-axis
4. Explain why git is valuable to a team of developers.
It allows for indivudual developers to collabaorate with one another by having acces to apst and current versions of the code.
5. Define mobile-first design in your own words.
Mobile-first design is responsive design necessary for a better user experience on a mobile sized screen. Your site must be able to respond and act well on a mobile sized device.
